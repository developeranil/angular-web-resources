...
import { dayjsRef } from '../dayjsRef/dayjs.ref';
...
describe('Service: ObUtilsService', () => {
  ...
  it('should check if date is in range', inject([UtilsService], (service: UtilsService) => {
    ...
    expect(service.isDateInRange(dayjsRef(), dayjsRef().subtract(1, 'd'), dayjsRef(null))).toBeTruthy();
    expect(service.isDateInRange(dayjsRef(), dayjsRef(null), dayjsRef().add(1, 'd'))).toBeTruthy();
    expect(service.isDateInRange(dayjsRef().subtract(2, 'd'), dayjsRef().subtract(1, 'd'), dayjsRef().add(1, 'd')))
      .toBeFalsy();
    expect(service.isDateInRange(dayjsRef(), dayjsRef().add(3, 'd'), dayjsRef(null))).toBeFalsy();
    expect(service.isDateInRange(dayjsRef(), dayjsRef(null), dayjsRef().subtract(3, 'd'))).toBeFalsy();
    expect(service.isDateInRange(dayjsRef(), dayjsRef(null), dayjsRef(null))).toBeTruthy();
